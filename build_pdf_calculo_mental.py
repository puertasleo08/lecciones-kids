...
def create_access_pdf(output_pdf_path):
    ...
    url = "https://drive.google.com/drive/folders/1Z65UBHGeqTHeRHYstwI1V0QfBWP3_0dU?usp=sharing"
    ...
    story.append(Paragraph(
        "Tu cuaderno completo y solucionario ya están listos en formato digital de alta resolución. Para acceder a todos los archivos y descargarlos inmediatamente, usa cualquiera de las opciones a continuación:",
        subtitle_style
    ))
    story.append(Spacer(1, 3.5*mm))

    # 4. Product Preview Card (Using user uploaded spiral cover)
    capa_path = r"d:\dev\LECCIONES KIDS\imagens-pg-vendas\capa-calculo-mental-caderno.png"
    if not os.path.exists(capa_path):
        capa_path = r"d:\dev\LECCIONES KIDS\imagens-pg-vendas\capa-calculo-mental.jpg"

    if os.path.exists(capa_path):
        capa_img = RLImage(capa_path, width=3.3*cm, height=3.3*cm)
        product_cells = [
            Paragraph("<b>Secretos del Cálculo Mental Rápido (1.º al 5.º Grado)</b>", product_title_style),
            Spacer(1, 1*mm),
            Paragraph("Ayuda a los niños a hacer cálculos mentales más rápido que con una calculadora. Descubre trucos sencillos, atajos matemáticos poderosos y técnicas avanzadas que la escuela tradicional nunca les enseña, potenciando su agilidad.", product_desc_style),
            Spacer(1, 1.5*mm),
            Paragraph("&bull; ¡Incluye solucionario completo paso a paso! &bull; Archivos PDF listos para imprimir", product_item_style),
...
if __name__ == "__main__":
    out_pdf = r"d:\dev\LECCIONES KIDS\Acceso_Calculo_Mental_Rapido.pdf"
    ...
    preview_path = r"d:\dev\LECCIONES KIDS\preview_calculo_mental.png"
